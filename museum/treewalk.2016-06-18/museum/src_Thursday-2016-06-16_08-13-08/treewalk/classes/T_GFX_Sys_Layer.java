...
public class T_GFX_Sys_Layer
{
    ...
    private String                                                  fID;
    private T_AUX_Storage_Collection<I_GFX_Resource>                fResources;
    
    public T_GFX_Sys_Layer (T_GFX_Sys_View host, String id)
    {
        fHost       = host;
        fID         = id;
        fResources  = new T_AUX_Storage_Collection<I_GFX_Resource> ();
    }
    
    /**
     * @param res
     */
    public void Resource_GFX_Add (I_GFX_Resource res)
    {
        String key;
